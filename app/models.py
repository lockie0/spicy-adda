...
class User(UserMixin, db.Model):
    ...
    address_full_name = db.Column(db.String(120), nullable=True)
    address_mobile = db.Column(db.String(20), nullable=True)
    address_house = db.Column(db.String(120), nullable=True)
    ...
    address_pincode = db.Column(db.String(12), nullable=True)
